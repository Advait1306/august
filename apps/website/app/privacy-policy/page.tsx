...
export const metadata = {
  title: "Privacy Policy - August",
  description: "Privacy policy for August",
};
        ...
        <main className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sixhuman
              Technologies Private Limited, 235, Binnamangala, 2nd Floor, 13th
              Cross Road 2nd Stage.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to August, accessible from
              https://august.tech
            </li>
            <li>
          ...
          <h2 className="text-3xl font-bold mt-8 mb-4">Disclosure of Your Personal Data</h2>

          <h3 className="text-2xl font-semibold mt-6 mb-3">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Other legal requirements</h3>
          <p>
          ...
          <h2 className="text-3xl font-bold mt-8 mb-4">Security of Your Personal Data</h2>
          <p>
          ...
          <p>By email: tech@sixhuman.com</p>
        </main>
      </div>
    </div>
  );
