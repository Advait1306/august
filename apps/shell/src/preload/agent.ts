...
export const agent = {
  ...
  baseAgents: {
    getAll: (): Promise<BaseAgent[]> => electronAPI.ipcRenderer.invoke('base-agents:getAll'),
  ...
  agents: {
    getAll: (): Promise<Agent[]> => electronAPI.ipcRenderer.invoke('agents:getAll'),
    create: (data: NewAgent): Promise<Agent> =>
      electronAPI.ipcRenderer.invoke('agents:create', data),
    get: (id: string): Promise<Agent & { memories: AgentMemory[]; baseAgent: BaseAgent }> =>
    ...
    delete: (id: string): Promise<boolean> => electronAPI.ipcRenderer.invoke('agents:delete', id)
  },
