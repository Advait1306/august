...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-popover text-popover-foreground border border-popover-border flex h-full w-full flex-col overflow-hidden rounded-md",
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  /** Set to false when doing server-side filtering */
